...
# Initialize the PDK
# $PDK_ROOT contains the path to ihp-sg13g2 in the iic_osic_tools container
set PDK_ROOT $::env(PDK_ROOT)
set pdk_cells_lib ${PDK_ROOT}/ihp-sg13g2/libs.ref/sg13g2_stdcell/lib
set pdk_cells_lef ${PDK_ROOT}/ihp-sg13g2/libs.ref/sg13g2_stdcell/lef
set pdk_sram_lib  ${PDK_ROOT}/ihp-sg13g2/libs.ref/sg13g2_sram/lib
set pdk_sram_lef  ${PDK_ROOT}/ihp-sg13g2/libs.ref/sg13g2_sram/lef
set pdk_io_lib    ${PDK_ROOT}/ihp-sg13g2/libs.ref/sg13g2_io/lib
set pdk_io_lef    ${PDK_ROOT}/ihp-sg13g2/libs.ref/sg13g2_io/lef

# We don't actually have it in this container, I think.
# set pdk_pad_lef   ${PDK_ROOT}/bondpad/lef
